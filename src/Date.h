...
void parseUnixTime(uint32_t unixtime, int8_t &hour, int8_t &minute, int8_t &second, uint8_t &weekday, int8_t &day,
                   int8_t &month,
                   int16_t &year); // Разобрать время в формате UNIX-time (количество секунд с 01.01.1970)
uint32_t combineUnixTime(int8_t hour, int8_t minute, int8_t second, int8_t day, int8_t month,
                         int16_t year); // Собрать время в формат UNIX-time
...
String timeDateToStr(int8_t hour, int8_t minute, int8_t second, int8_t day, int8_t month,
                     int16_t year); // Время и дата в строку
String timeDateToStr(uint32_t unixtime); // Время и дата в формате UNIX-time в строку
String dateTimeToStr(int8_t day, int8_t month, int16_t year, int8_t hour, int8_t minute,
                     int8_t second); // Дата и время в строку
