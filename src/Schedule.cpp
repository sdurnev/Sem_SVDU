...
uint32_t Schedule::next(uint32_t unixtime) {
    ...
    if (_period != NONE) {
        ...
        if (_period == MINUTELY) {
            ...
            if (((_weekdays & (1 << wd)) == 0) ||
                ((hh > _hour) || ((hh == _hour) && ((mm > _minute) || ((mm == _minute) && (ss > _second)))))) {
                do {
                    nextDay(d, m, y);
                    wd = (wd + 1) % 7;
            ...
            if (_day == LASTDAYOFMONTH)
                ...
                dd = _day;
            if ((d > dd) || ((d == dd) && ((hh > _hour) || ((hh == _hour) && ((mm > _minute) ||
                                                                              ((mm == _minute) && (ss > _second))))))) {
                if (++m > 12) {
                    m = 1;
                    y++;
                }
            ...
            if (_day == LASTDAYOFMONTH)
                ...
                dd = _day;
            if ((m > _month) || ((m == _month) && ((d > dd) || ((d == dd) && ((hh > _hour) || ((hh == _hour) &&
                                                                                               ((mm > _minute) ||
                                                                                                ((mm == _minute) &&
                                                                                                 (ss >
                                                                                                  _second))))))))) {
            ...
            if (_day == LASTDAYOFMONTH)
                ...
                dd = _day;
            if ((y > _year) || ((y == _year) && ((m > _month) || ((m == _month) && ((d > dd) || ((d == dd) &&
                                                                                                 ((hh > _hour) ||
                                                                                                  ((hh == _hour) &&
                                                                                                   ((mm > _minute) ||
                                                                                                    ((mm == _minute) &&
...
String Schedule::toString() {
    static const char *const everyStr PROGMEM = "Every ";
    static const char *const atStr PROGMEM = " at ";
    static const char *const lastStr PROGMEM = "last";
